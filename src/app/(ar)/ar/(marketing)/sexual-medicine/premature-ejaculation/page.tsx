...
const glansProcedurePoints = [
  ...
  "لا يُناقش إلا إلى جانب الخيارات السلوكية والنفسية-جنسية والطبية أعلاه، بما يلائم نتائج التقييم الفردي.",
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer: "لا. يُختار العلاج وفقًا للنمط المعني والعوامل المساهمة والأولويات الفردية — تُراعى الخيارات السلوكية والنفسية-جنسية إلى جانب الخيارات الطبية والإجرائية، لا يُتجاوزان.",
  },
  {
    question: "كيف أبدأ؟",
